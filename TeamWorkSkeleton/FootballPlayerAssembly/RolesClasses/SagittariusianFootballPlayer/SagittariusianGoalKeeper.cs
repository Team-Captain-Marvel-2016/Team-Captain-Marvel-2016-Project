namespace FootballPlayerAssembly.RolesClasses.SagittariusianFootballPlayer
{
    ...
    public static partial class FootballPlayerFactory
    {
        ...
        {
            public SagittariusianGoalkeeper(FootballPlayerFactoryClasses.GenericFootballPlayerClasses.FootballPlayerFactory.GenericFootballPlayer player) : base(player)
            {
            }
